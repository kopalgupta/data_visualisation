...
#Edge attributes
g["Alan"]["Bob"]["relationship"] = "Friends"
g["Carol"]["Denise"]["relationship"] = "Friends"
g["Carol"]["Bob"]["relationship"] = "Married"
...
for e in g.edges():
	n1=e[0]
	n2=e[1]
	print("{0} and {1} are {2}".format(n1,n2,g[n1][n2]["relationship"]))

#Save g to the file my_graph.graphml in graphml format
#prettyprint will make it nice for a human to read
nx.write_graphml(g,"my_graph.graphml",prettyprint=True) # creates gml file
